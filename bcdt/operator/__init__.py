...
from bcdt.operator.manager import LocalOperatorManager, BCDT_HOME
from bcdt.exceptions import BCDTOperatorException
...
class Operator:
    def __init__(self, path):
        ...
        try:
            ...
            raise BCDTOperatorException(f"failed to load operator: {e}")
